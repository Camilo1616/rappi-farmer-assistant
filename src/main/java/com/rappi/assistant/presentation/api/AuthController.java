...
public class AuthController {
    ...
    private final com.rappi.assistant.application.services.EmailPinService emailPinService;
    private final com.rappi.assistant.application.SessionContext sessionContext;
    ...
    public ResponseEntity<?> setWaPhoneAge(@RequestBody Map<String, String> body) {
        ...
        try {
            ...
            java.util.Optional<com.rappi.assistant.domain.entities.User> user = userService.findUserById(userId);
    ...
    public record RegisterRequest(
            String fullName, String email, String password, String pin) {}
